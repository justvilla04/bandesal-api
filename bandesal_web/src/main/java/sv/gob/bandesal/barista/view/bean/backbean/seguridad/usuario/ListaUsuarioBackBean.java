package sv.gob.bandesal.barista.view.bean.backbean.seguridad.usuario;

import lombok.Data;
import lombok.EqualsAndHashCode;
import sv.gob.bandesal.barista.businesslogic.service.core.SeguridadService;
import sv.gob.bandesal.barista.businesslogic.service.core.auditoria.AuditoriaService;
import sv.gob.bandesal.barista.businesslogic.service.infraestructura.EntidadService;
import sv.gob.bandesal.barista.businesslogic.service.seguridad.PermisoService;
import sv.gob.bandesal.barista.businesslogic.service.seguridad.RoleService;
import sv.gob.bandesal.barista.businesslogic.service.seguridad.UsuarioService;
import sv.gob.bandesal.barista.model.entity.infraestructura.Entidad;
import sv.gob.bandesal.barista.model.entity.seguridad.Permiso;
import sv.gob.bandesal.barista.model.entity.seguridad.Role;

import sv.gob.bandesal.barista.model.entity.seguridad.Usuario;
import sv.gob.bandesal.barista.model.utils.RegExpresion;
import sv.gob.bandesal.barista.view.bean.backbean.BaseBackBean;
import sv.gob.bandesal.barista.view.bean.session.SessionList;
import sv.gob.bandesal.barista.view.utils.treeMenu.Tree;
import sv.gob.bandesal.barista.view.utils.web.MessagesResults;
 ...
 * BackBean para pantalla Usuarioes</br>
 *
 ...
 * @since 1.0 *
 * Modificaciones
 * Correcciones y modificación en la funcionalidad de generar clave de usuario
 * @since 2016-10-07
 * Modificado por jvillanueva 09/04/2021
 * Modificado el 08/08/2023 por jvillanueva
 * Modificado el 21/08/2023 por jvillanueva
 */
...
@Named
@Scope("view")
public class ListaUsuarioBackBean extends BaseBackBean implements Serializable {
    /**
     * ******************************************************************************
     * VARIABLES
     * ******************************************************************************
    ...
    @Inject
    @Autowired
    public ListaUsuarioBackBean(UsuarioService oUsuarioService, SeguridadService oSeguridadService, AuditoriaService oDialogAuditoriaService,
